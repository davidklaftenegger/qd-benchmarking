...
benchmarked_locks = [
    ...
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd'},
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd_futex'},
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd_cas'},
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd_nodetach'},
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd_starve'},
    {'lock_defines': ['USE_CPPLOCK'],
     'lock_alias' : 'cpp_hqd_tatas'},
    {'lock_defines': ['USE_CPPLOCK'],
...
for locked_data_stucture in locked_data_stuctures:
    for benchmarked_lock in benchmarked_locks:
        ...
        if 'cpp_hqd' == lock_alias:
		  ...
		  numa_structure_defines()))
            objs.append(cppglue)
        if 'cpp_hqd_futex' == lock_alias:
            cppglue = env.Object(
                target = (data_structure_alias + '_' + lock_alias + 'cpp_hqd_futex.o'),
                source = ['src/datastructures_bench/synch_algorithms/glue_hqd_futex.cpp'],
                CPPPATH='qd_library:.',
                CPPDEFINES = ([data_structure_define,
		   print_thread_queue_stats_define,
		   queue_stats_define] + 
		  ...
		  numa_structure_defines()))
            objs.append(cppglue)
        if 'cpp_hqd_cas' == lock_alias:
            cppglue = env.Object(
                target = (data_structure_alias + '_' + lock_alias + 'cpp_hqd_cas.o'),
                source = ['src/datastructures_bench/synch_algorithms/glue_hqd_cas.cpp'],
                CPPPATH='qd_library:.',
                CPPDEFINES = ([data_structure_define,
		   print_thread_queue_stats_define,
		   queue_stats_define] + 
		  ...
		  numa_structure_defines()))
            objs.append(cppglue)
        if 'cpp_hqd_nodetach' == lock_alias:
            cppglue = env.Object(
                target = (data_structure_alias + '_' + lock_alias + 'cpp_hqd_nodetach.o'),
                source = ['src/datastructures_bench/synch_algorithms/glue_hqd_nodetach.cpp'],
                CPPPATH='qd_library:.',
                CPPDEFINES = ([data_structure_define,
		   print_thread_queue_stats_define,
		   queue_stats_define] + 
		  ...
		  numa_structure_defines()))
            objs.append(cppglue)
        if 'cpp_hqd_starve' == lock_alias:
            cppglue = env.Object(
                target = (data_structure_alias + '_' + lock_alias + 'cpp_hqd_starve.o'),
                source = ['src/datastructures_bench/synch_algorithms/glue_hqd_starve.cpp'],
                CPPPATH='qd_library:.',
                CPPDEFINES = ([data_structure_define,
		   print_thread_queue_stats_define,
		   queue_stats_define] + 
		  ...
		  numa_structure_defines()))
            objs.append(cppglue)
        if 'cpp_hqd_tatas' == lock_alias:
            cppglue = env.Object(
                target = (data_structure_alias + '_' + lock_alias + 'cpp_hqd_tatas.o'),
                source = ['src/datastructures_bench/synch_algorithms/glue_hqd_tatas.cpp'],
                CPPPATH='qd_library:.',
                CPPDEFINES = ([data_structure_define,
		   print_thread_queue_stats_define,
		   queue_stats_define] + 
