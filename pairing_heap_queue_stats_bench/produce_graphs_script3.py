...
mycolors = ['b', 'g', 'r', 'c', 'm', 'y', 'k', '#660000'] #etc
...
def set_up_figure(title):
    ...
    plt.ylabel('Operations / Help Session') 
...
complete_figure("pairingheap_lwhelp_all")
...
complete_figure("pairingheap_lwhelp_hqd")
...
complete_figure("pairingheap_lwhelp_qd")
