  ...
  class Cursor : public BasicDB::Cursor {
   ...
   public:
    ...
    virtual ~Cursor() {
      ...
      result<bool> res;
      delegatable<decltype(hide::taskfun), bool, decltype(this)> task(hide::taskfun, &res, this);
      db_->mlock_.lock_delegate(&task);
...
//      });
      ...
      result<bool> res;
      if(!writable && !step) {
	delegatable<decltype(hide::taskfun_ff), bool, decltype(this), decltype(err), decltype(visitor)> task(hide::taskfun_ff, &res, this, err, visitor);
	db_->mlock_.lock_delegate(&task);
	return res.get();
      } else if(!writable && step) {
	delegatable<decltype(hide::taskfun_ft), bool, decltype(this), decltype(err), decltype(visitor)> task(hide::taskfun_ft, &res, this, err, visitor);
	db_->mlock_.lock_delegate(&task);
	return res.get();
      } else if(writable && !step) {
	delegatable<decltype(hide::taskfun_tf), bool, decltype(this), decltype(err), decltype(visitor)> task(hide::taskfun_tf, &res, this, err, visitor);
	db_->mlock_.lock_delegate(&task);
	return res.get();
      } else { // == if(writable && step) {
	delegatable<decltype(hide::taskfun_tt), bool, decltype(this), decltype(err), decltype(visitor)> task(hide::taskfun_tt, &res, this, err, visitor);
	db_->mlock_.lock_delegate(&task);
	return res.get();
      } 
...
//      return f.get();
    ...
    bool jump() {
      ...
      result<bool> res;
      delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(err)> task(hide::taskfun, &res, this, err);
      db_->mlock_.lock_delegate(&task);
      return res.get();
    }
    /**
...
//      auto ksiz = ksiz_p;
      ...
      result<bool> res;
      delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(err), decltype(kbuf), decltype(ksiz_p)> task(hide::taskfun, &res, this, err, kbuf, ksiz_p);
      db_->mlock_.lock_delegate(&task);
      return res.get();
    }
    /**
    ...
    bool step() {
      ...
      result<bool> res;
      delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(error)> task(hide::taskfun, &res, this, error);
      db_->mlock_.lock_delegate(&task);
      return res.get();
    }
    /**
...
//    auto writable = std::get<3>(*tuple);
    ...
    result<bool> res;
    if(writable) {
        delegatable<decltype(hide::taskfun_t), bool, decltype(this), decltype(err), decltype(visitor), decltype(checker)> task(hide::taskfun_t, &res, this, err, visitor, checker);
        mlock_.lock_delegate(&task);
	return res.get();
    } else {
        delegatable<decltype(hide::taskfun_f), bool, decltype(this), decltype(err), decltype(visitor), decltype(checker)> task(hide::taskfun_f, &res, this, err, visitor, checker);
        mlock_.lock_delegate(&task);
	return res.get();
    }
  }
...
*/
  ...
  bool begin_transaction(bool hard = false) {
	...
	return retry;
      ...
      delegatable<decltype(hide::taskfun), transaction_start, decltype(this), decltype(err)> task(hide::taskfun, &res, this, err);
      mlock_.lock_delegate(&task);
...
//    auto hard = std::get<2>(*tuple); // not used at all
    ...
    result<bool> res;
    delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(err), decltype(hard)> task(hide::taskfun, &res, this, err, hard);
    mlock_.lock_delegate(&task);
    return res.get();
  }
  /**
  ...
  bool end_transaction(bool commit = true) {
    ...
    result<bool> res;
    delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(err), decltype(commit)> task(hide::taskfun, &res, this, err, commit);
    mlock_.lock_delegate(&task);
    return res.get();
  }
  /**
  ...
  bool switch_rotation(bool rttmode) {
    ...
    result<bool> res;
    delegatable<decltype(hide::taskfun), bool, decltype(this), decltype(rttmode)> task(hide::taskfun, &res, this, rttmode);
    mlock_.lock_delegate(&task);
    return res.get();
  }
  /**
